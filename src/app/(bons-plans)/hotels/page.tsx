...
function HotelsPage() {
  ...
  useEffect(() => {
    ...
    router.replace(`/hotels${qs ? `?${qs}` : ''}`, { scroll: false });
    ...
    <main className="min-h-screen bg-[#0a0a0f]">
              ...
              <button
                ...
                className={`flex items-center gap-2 px-3 py-2.5 rounded-xl text-sm transition-colors ${
                  hasActiveFilters
                    ...
                    : 'bg-white text-[#8B7E6E] hover:text-[#D97706] shadow-md border border-gray-100'
                }`}
              >
      ...
      <section className="py-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {/* Hotels list — mobile: list style / desktop: grid */}
                  ...
                  >
                    ...
                    <div className="flex-1 p-3 lg:p-4 flex flex-col justify-between">
                      <div>
                        ...
                        {/* Amenities — mobile: text / desktop: icons */}
