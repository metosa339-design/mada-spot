      ...
      <section className="relative py-16 md:py-24 px-4">
        ...
        <div className="relative max-w-5xl mx-auto text-center">
          <h1 className="text-3xl md:text-5xl font-bold text-white mb-4">
            {t.heroTitle} <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-400 to-pink-500">{t.heroTitleHighlight}</span>
          </h1>
      ...
      <div className="max-w-6xl mx-auto px-4 pb-20">
        ...
        {rest.length > 0 ? (
          ...
          <div className="text-center py-20">
            ...
            <p className="text-xl text-white/60">{t.noArticlesYet}</p>
            <p className="text-white/40 mt-2">{t.comeBackSoon}</p>
          </div>
        ) : null}
      </div>
    </>
