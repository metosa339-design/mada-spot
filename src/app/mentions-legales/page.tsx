...
export default function MentionsLegalesPage() {
  ...
  const listClassNone = "list-none space-y-1.5 pl-0 text-[#334155] text-[14px] leading-relaxed max-w-[65ch]";
    ...
    <div className="min-h-screen flex flex-col bg-[#F8FAFC]" style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
      ...
      <main className="flex-1">
        <div className="max-w-3xl mx-auto px-4 pt-28 pb-16">
          ...
          <h1 className="text-[32px] sm:text-[40px] font-semibold tracking-[-0.03em] text-[#0F172A] mb-2">{t.mlTitle}</h1>
          <p className="text-[12px] font-mono text-[#94A3B8] mb-10">{t.mlUpdatePrefix} {currentYear}</p>

          <div className="space-y-10 text-[#334155] [&_p]:text-[#334155] [&_p]:leading-relaxed [&_p]:text-[14px] [&_p]:max-w-[65ch] [&_strong]:text-[#0F172A] [&_strong]:font-semibold [&_code]:text-[#FF6B35] [&_code]:font-mono [&_code]:text-[12px] [&_p.mt-3]:mt-4 [&_section_>_p]:mb-2 [&_section_>_p:last-child]:mb-0">
            <section>
