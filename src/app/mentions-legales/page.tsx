      ...
      <main className="flex-1">
        <div className="max-w-3xl mx-auto px-4 py-12">
          <Link href="/" className="inline-flex items-center gap-1 text-gray-500 hover:text-gray-700 text-sm mb-6">
            <ArrowLeft className="w-4 h-4" /> {t.mlBackHome}
          </Link>

          <h1 className="text-3xl font-bold text-gray-900 mb-2">{t.mlTitle}</h1>
          <p className="text-sm text-gray-500 mb-8">{t.mlUpdatePrefix} {currentYear}</p>

          <div className="prose prose-gray max-w-none space-y-8">
            <section>
              <h2 className="text-xl font-semibold text-gray-800">{t.ml1Title}</h2>
              <p>{t.ml1Intro}</p>
              <ul className="list-none space-y-1 pl-0">
                ...
                <li><strong>{t.ml1Email}</strong> <a href="mailto:contact@madaspot.com" className="text-orange-500 underline">contact@madaspot.com</a></li>
            ...
            <section>
              <h2 className="text-xl font-semibold text-gray-800">{t.ml2Title}</h2>
              <p>{t.ml2Intro}</p>
              <ul className="list-none space-y-1 pl-0">
                ...
                <li><strong>{t.ml2HostWeb}</strong> <a href="https://www.ionos.fr" target="_blank" rel="noopener noreferrer" className="text-orange-500 underline">www.ionos.fr</a></li>
              </ul>
            ...
            <section>
              <h2 className="text-xl font-semibold text-gray-800">{t.ml3Title}</h2>
              <p>{t.ml3Body1}</p>
              <p>{t.ml3Body2}</p>
              <p>{t.ml3Body3}</p>
            </section>
            ...
            <section>
              <h2 className="text-xl font-semibold text-gray-800">{t.ml4Title}</h2>
              <p>{t.ml4Body1}</p>
            ...
            <section>
              <h2 className="text-xl font-semibold text-gray-800">{t.ml5Title}</h2>
              <p>{t.ml5Intro}</p>
              <ul className="list-disc pl-6 space-y-1">
            ...
            <section>
              <h2 className="text-xl font-semibold text-gray-800">{t.ml6Title}</h2>
              <p>{t.ml6Intro}</p>
              <ul className="list-disc pl-6 space-y-1">
                <li>{t.ml6Li1}</li>
                <li>{t.ml6Li2}</li>
              ...
              <p>
                {t.ml6Body2}{' '}
                <Link href="/cgu" className="text-orange-500 underline">{t.ml6CguLink}</Link>.
              </p>
            </section>

            <section>
              <h2 className="text-xl font-semibold text-gray-800">{t.ml7Title}</h2>
              <p>{t.ml7Body}</p>
            </section>

            <section>
              <h2 className="text-xl font-semibold text-gray-800">{t.ml8Title}</h2>
              <p>{t.ml8Body}</p>
            </section>

            <section>
              <h2 className="text-xl font-semibold text-gray-800">{t.ml9Title}</h2>
              <p>{t.ml9Intro}</p>
              <ul className="list-none space-y-1 pl-0">
                <li><strong>{t.ml9Email}</strong> <a href="mailto:contact@madaspot.com" className="text-orange-500 underline">contact@madaspot.com</a></li>
                <li><strong>{t.ml9Form}</strong> <Link href="/contact" className="text-orange-500 underline">{t.ml9FormValue}</Link></li>
