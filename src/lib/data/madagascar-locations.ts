...
// Liste plate canonique de toutes les villes de Madagascar
// (chefs-lieux + villes notables des 22 régions + destinations touristiques)
// Alphabétique, alias inclus (Majunga/Mahajanga, Tulear/Toliara, etc.)
export const MADAGASCAR_CITIES: string[] = [
  'Ambalavao',
  'Ambanja',
  'Ambato Boeny',
  'Ambatofinandrahana',
